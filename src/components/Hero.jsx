...
export default function Hero() {
  ...
  return (
    <div id="home" className="text-white min-h-screen flex flex-col items-center justify-center px-6 select-none py-40">
      {/* Hero Text */}
      <h1
        className="text-4xl md:text-6xl font-bold mb-4 text-center flex items-center gap-2 "
      ...
      {/* 🎬 Course Intro Video */}
<div className="relative w-full max-w-4xl aspect-video mb-12 rounded-2xl overflow-hidden border border-teal-400/40 shadow-[0_10px_30px_rgba(0,0,0,0.6),0_0_40px_10px_rgba(13,148,136,0.4)]">
