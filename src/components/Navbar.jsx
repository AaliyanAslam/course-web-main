...
>
  ...
  <ul className="flex flex-col items-center gap-8">
    <li className="hover:text-teal-400 transition-all cursor-pointer">Home</li>
    <li className="hover:text-teal-400 transition-all cursor-pointer">Courses</li>
    <li className="hover:text-teal-400 transition-all cursor-pointer">About</li>
    <li className="hover:text-teal-400 transition-all cursor-pointer">Contact</li>
  </ul>
