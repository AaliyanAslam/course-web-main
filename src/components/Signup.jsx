...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 select-none py-30">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex flex-col gap-6 px-8">
          <div className="flex items-center gap-3" style={{ fontFamily: "Poppins" }}>
            ...
            <div>
              <h3 className="text-2xl font-semibold text-white tracking-tight" style={{fontFamily: "poppins"}}>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 shadow-xl">
            <h2 className="text-3xl font-bold text-white mb-2" style={{fontFamily: "poppins"}}>
              Create Your Account 🚀
            </h2>
        ...
        <div className="bg-black/60 backdrop-blur-md border border-white/10 rounded-3xl p-8 shadow-2xl">
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2" style={{fontFamily: "montserrat"}}>
            Sign Up
          </h1>
          <p className="text-sm text-gray-300 mb-6" style={{fontFamily: "montserrat"}}>
          ...
          <div className="mt-6 text-center text-sm text-gray-300">or sign up with</div>
          ...
          <p className="text-center text-sm text-gray-400 mt-6 flex justify-center ">
            Already have an account?{" "}
            <p className="text-teal-200 font-medium hover:underline cursor-pointer" onClick={()=> {
                navigate("/login")
            }}>
              Sign in
            </p>
